...
class MyApp(QWidget):
    ...
    def set_gps_table(self):
        ...
        self.gps_table.setHorizontalHeaderLabels(["     경기장 좌표계     ", "gps  지구 좌표계"])
    ...
    def set_imu_table(self):
        ...
        self.imu_table.setColumnCount(2)
        self.imu_table.setHorizontalHeaderLabels(["     경기장 좌표계     ", "imu  지구 좌표계"])
        self.imu_table.setEditTriggers(QAbstractItemView.DoubleClicked)
        self.imu_table.horizontalHeader().setSectionResizeMode(1, QHeaderView.Stretch)
