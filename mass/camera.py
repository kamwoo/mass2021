...
pub = rospy.Publisher('camera_direct', String, queue_size = 1)
...
YOLO_net = cv2.dnn.readNet("/home/taeyong/self/src/camera/src/yolov3-tiny_final.weights", "/home/taeyong/self/src/camera/src/yolov3-tiny.cfg")
...
with open("/home/taeyong/self/src/camera/src/obj.names", "r") as f:
...
while (VideoSignal.isOpened()):
    ...
    for cont in contours:
        if cv2.contourArea(cont) > 20000.0:  # 숫자 바꾸기
